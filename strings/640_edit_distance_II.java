...
/*
Thought process:
    1. There are two cases that two strings are one edit distance away from each other:
    ...
    2. Notice two corner cases: return false if difference of lengths is greater than 1 or two strings are extactly the same (no distance)
    3. Differentiate the shorter string from the longer one. Create two index variables and a count variable to keep the number of different characters.
