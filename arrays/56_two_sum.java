...
/*
Thought process:
    O(n) time and O(n) space solution: use hash map to store <target-number, index> pairs. 
    ...
    Retrieve the indices of these two numbers - the first is the matched key, the second is just the current iteration number. 
