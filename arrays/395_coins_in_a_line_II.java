...
/*
Thought process:
    1. State: dp[i] records the max value one can get from ith coin to the end
    2. Function: when we are at ith coin, we have 2 choices:
       1) values[i]
          The competitor have 2 choices too: 
            a. values[i+1]
            b. values[i+1] + values[i+2]
          Given that the competitor is reasonable who want to make you gain least value for the rest of game, 
     ...
     3. Solution: fianlly, dp[i] = min(best1, best2)
*/
