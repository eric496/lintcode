...
/*
Thought process:
    1. O(n) time and O(1) space: Bottom-up method, from the second to the last row, add the current element value with the smaller value from its two children,
       store it at the current position. Keep moving upward until most top and return triangle[0][0] which stores the min path sum. 
       Notice this method saves space at the expense of changing the values of the triangle.
*/
